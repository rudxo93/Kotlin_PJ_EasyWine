...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentSyrahBinding
...
class TempranilloFragment : Fragment() {

    private lateinit var binding: FragmentTempranilloBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_tempranillo, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_tempranilloFragment_to_fragment_type)
        }
