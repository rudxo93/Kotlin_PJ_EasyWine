...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentMenciaBinding
...
class MenciaFragment : Fragment() {

    private lateinit var binding: FragmentMenciaBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_mencia, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_menciaFragment_to_fragment_type)
        }
