...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentWineKeepBinding
import com.duran.gyoung_tae_93.pj.easywine.ui.view.activity.MainActivity
import com.google.android.material.bottomnavigation.BottomNavigationView

class WineKeepFragment : Fragment() {

    private lateinit var binding: FragmentWineKeepBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_wine_keep, container, false)
        return binding.root
    }
    ...
    private fun getToolbarSetting() {
        binding.wkToolbar.setTitle("남은 와인 보관하기")
