...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentUSABinding

class USAFragment : Fragment() {

    private lateinit var binding: FragmentUSABinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_u_s_a, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_USAFragment_to_fragment_type)
        }
    }
