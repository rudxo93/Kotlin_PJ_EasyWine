...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentViognierBinding
...
class CheninBlancFragment : Fragment() {

    private lateinit var binding: FragmentCheninBlancBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_chenin_blanc, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_cheninBlancFragment_to_fragment_type)
        }
