...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentPetiteSirahBinding
...
class PetiteSirahFragment : Fragment() {

    private lateinit var binding: FragmentPetiteSirahBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_petite_sirah, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_petiteSirahFragment_to_fragment_type)
        }
