...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentSoaveBinding
...
class VermentinoFragment : Fragment() {

    private lateinit var binding: FragmentVermentinoBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_vermentino, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_vermentinoFragment_to_fragment_type)
        }
