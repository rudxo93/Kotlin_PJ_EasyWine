...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentCheninBlancBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentGewurztraminerBinding
...
class GewurztraminerFragment : Fragment() {

    private lateinit var binding: FragmentGewurztraminerBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_gewurztraminer, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_gewurztraminerFragment_to_fragment_type)
        }
