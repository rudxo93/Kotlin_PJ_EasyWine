...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentGamayBinding
...
class GamayFragment : Fragment() {

    private lateinit var binding: FragmentGamayBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_gamay, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_gamayFragment_to_fragment_type)
        }
