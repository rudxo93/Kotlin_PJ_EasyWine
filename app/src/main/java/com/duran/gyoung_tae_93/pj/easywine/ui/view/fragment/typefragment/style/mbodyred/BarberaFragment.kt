...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentPinotNoirBinding
...
class BarberaFragment : Fragment() {

    private lateinit var binding: FragmentBarberaBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_barbera, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_barberaFragment_to_fragment_type)
        }
