...
class PinotNoirFragment : Fragment() {

    private lateinit var binding: FragmentPinotNoirBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_pinot_noir, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_pinotNoirFragment_to_fragment_type)
        }
