...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentCarmenereBinding
...
class CarmenereFragment : Fragment() {

    private lateinit var binding: FragmentCarmenereBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_carmenere, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_carmenereFragment_to_fragment_type)
        }
