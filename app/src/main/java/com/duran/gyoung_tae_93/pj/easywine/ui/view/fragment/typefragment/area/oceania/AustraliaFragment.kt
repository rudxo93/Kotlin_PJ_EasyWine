...
class AustraliaFragment : Fragment() {
    ...
    private lateinit var binding: FragmentAustraliaBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_australia, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_australiaFragment_to_fragment_type)
        }
    }
