...
class NebbioloFragment : Fragment() {

    private lateinit var binding: FragmentNebbioloBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_nebbiolo, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_nebbioloFragment_to_fragment_type)
        }
