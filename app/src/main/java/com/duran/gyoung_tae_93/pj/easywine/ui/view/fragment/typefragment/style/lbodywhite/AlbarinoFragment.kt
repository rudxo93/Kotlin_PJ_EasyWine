...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentAlbarinoBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentCavaBinding
...
class AlbarinoFragment : Fragment() {

    private lateinit var binding: FragmentAlbarinoBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_albarino, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_albarinoFragment_to_fragment_type)
        }
