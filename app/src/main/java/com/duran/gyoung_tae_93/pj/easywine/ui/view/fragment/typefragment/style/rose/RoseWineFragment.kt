...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentRoseWineBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentTorrontesBinding
...
class RoseWineFragment : Fragment() {

    private lateinit var binding: FragmentRoseWineBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_rose_wine, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_roseWineFragment_to_fragment_type)
        }
