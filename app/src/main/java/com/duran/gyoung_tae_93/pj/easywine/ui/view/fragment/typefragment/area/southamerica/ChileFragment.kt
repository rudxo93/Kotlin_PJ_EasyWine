...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentChileBinding

class ChileFragment : Fragment() {

    private lateinit var binding: FragmentChileBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_chile, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_chileFragment_to_fragment_type)
        }
    }
