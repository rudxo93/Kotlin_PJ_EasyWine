...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentGruenerBinding
...
class MuscadetFragment : Fragment() {

    private lateinit var binding: FragmentMuscadetBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_muscadet, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_muscadetFragment_to_fragment_type)
        }
