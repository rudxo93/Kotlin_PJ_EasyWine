...
class LambruscoFragment : Fragment() {
    ...
    private lateinit var binding: FragmentLambruscoBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_lambrusco, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_lambruscoFragment_to_fragment_type)
        }
