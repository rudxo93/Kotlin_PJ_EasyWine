...
class FranceRhoneFragment : Fragment() {

    private lateinit var binding: FragmentFranceRhoneBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_france_rhone, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_franceRhoneFragment_to_fragment_type)
        }
    }
