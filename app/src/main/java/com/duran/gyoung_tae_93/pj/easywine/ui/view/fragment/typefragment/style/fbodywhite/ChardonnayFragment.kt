...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentChardonnayBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentVermentinoBinding
...
class ChardonnayFragment : Fragment() {

    private lateinit var binding: FragmentChardonnayBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_chardonnay, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_chardonnayFragment_to_fragment_type)
        }
