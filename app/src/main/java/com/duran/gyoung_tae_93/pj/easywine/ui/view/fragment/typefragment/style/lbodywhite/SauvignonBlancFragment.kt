...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentPinotGrisBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentSauvignonBlancBinding
...
class SauvignonBlancFragment : Fragment() {

    private lateinit var binding: FragmentSauvignonBlancBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_sauvignon_blanc, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_sauvignonBlancFragment_to_fragment_type)
        }
