...
class ViognierFragment : Fragment() {

    private lateinit var binding: FragmentViognierBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_viognier, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_viognierFragment_to_fragment_type)
        }
