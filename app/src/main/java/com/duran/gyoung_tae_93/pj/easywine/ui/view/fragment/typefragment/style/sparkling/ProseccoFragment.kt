...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentLambruscoBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentProseccoBinding
...
class ProseccoFragment : Fragment() {

    private lateinit var binding: FragmentProseccoBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_prosecco, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_proseccoFragment_to_fragment_type)
        }
