...
class PinotageFragment : Fragment() {

    private lateinit var binding: FragmentPinotageBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_pinotage, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_pinotageFragment_to_fragment_type)
        }
