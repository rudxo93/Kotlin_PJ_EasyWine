...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentPortugalBinding

class PortugalFragment : Fragment() {

    private lateinit var binding: FragmentPortugalBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_portugal, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_portugalFragment_to_fragment_type)
        }
    }
