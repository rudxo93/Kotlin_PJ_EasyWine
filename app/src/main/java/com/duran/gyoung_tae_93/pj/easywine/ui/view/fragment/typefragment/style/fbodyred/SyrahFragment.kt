...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentPinotageBinding
...
class SyrahFragment : Fragment() {

    private lateinit var binding: FragmentSyrahBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_syrah, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_syrahFragment_to_fragment_type)
        }
