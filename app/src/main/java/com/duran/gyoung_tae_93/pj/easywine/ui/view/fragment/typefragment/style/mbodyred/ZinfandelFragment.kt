...
class ZinfandelFragment : Fragment() {

    private lateinit var binding: FragmentZinfandelBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_zinfandel, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_zinfandelFragment_to_fragment_type)
        }
