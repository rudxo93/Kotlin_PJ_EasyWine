...
class SherryFragment : Fragment() {

    private lateinit var binding: FragmentSherryBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_sherry, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_sherryFragment_to_fragment_type)
        }
