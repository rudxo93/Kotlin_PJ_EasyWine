...
class TastingAcidityFragment : Fragment() {
    ...
    private lateinit var binding: FragmentTastingAcidityBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_tasting_acidity, container, false)
        return binding.root
    }
