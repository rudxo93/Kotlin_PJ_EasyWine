...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentMarsalaBinding
...
class MarsalaFragment : Fragment() {

    private lateinit var binding: FragmentMarsalaBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_marsala, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_marsalaFragment_to_fragment_type)
        }
