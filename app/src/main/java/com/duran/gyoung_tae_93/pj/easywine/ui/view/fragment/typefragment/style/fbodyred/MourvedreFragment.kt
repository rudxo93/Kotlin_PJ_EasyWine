...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentMalbecBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentMourvedreBinding
...
class MourvedreFragment : Fragment() {

    private lateinit var binding: FragmentMourvedreBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_mourvedre, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_mourvedreFragment_to_fragment_type)
        }
