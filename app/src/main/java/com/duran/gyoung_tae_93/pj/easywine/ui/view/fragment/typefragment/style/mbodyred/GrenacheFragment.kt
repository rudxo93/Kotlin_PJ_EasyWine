...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentGrenacheBinding
...
class GrenacheFragment : Fragment() {

    private lateinit var binding: FragmentGrenacheBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_grenache, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_grenacheFragment_to_fragment_type)
        }
