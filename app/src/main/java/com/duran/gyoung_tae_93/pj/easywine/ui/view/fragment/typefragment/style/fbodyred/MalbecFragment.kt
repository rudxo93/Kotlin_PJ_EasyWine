...
class MalbecFragment : Fragment() {

    private lateinit var binding: FragmentMalbecBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_malbec, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_malbecFragment_to_fragment_type)
        }
