...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentBarberaBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentCabernetFrancBinding
...
class CabernetFrancFragment : Fragment() {

    private lateinit var binding: FragmentCabernetFrancBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_cabernet_franc, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_cabernetFrancFragment_to_fragment_type)
        }
