...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentSpainBinding

class SpainFragment : Fragment() {

    private lateinit var binding: FragmentSpainBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_spain, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_spainFragment_to_fragment_type)
        }
    }
