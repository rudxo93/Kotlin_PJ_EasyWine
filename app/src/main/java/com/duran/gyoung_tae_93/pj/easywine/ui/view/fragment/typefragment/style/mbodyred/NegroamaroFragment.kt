...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentNegroamaroBinding
...
class NegroamaroFragment : Fragment() {

    private lateinit var binding: FragmentNegroamaroBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_negroamaro, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_negroamaroFragment_to_fragment_type)
        }
