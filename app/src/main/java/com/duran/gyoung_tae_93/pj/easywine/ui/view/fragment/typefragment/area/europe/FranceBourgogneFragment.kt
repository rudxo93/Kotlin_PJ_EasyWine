...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentFranceBourgogneBinding

class FranceBourgogneFragment : Fragment() {

    private lateinit var binding: FragmentFranceBourgogneBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_france_bourgogne, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_franceBourgogneFragment_to_fragment_type)
        }
    }
