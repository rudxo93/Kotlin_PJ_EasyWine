...
class GruenerFragment : Fragment() {

    private lateinit var binding: FragmentGruenerBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_gruener, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_gruenerFragment_to_fragment_type)
        }
