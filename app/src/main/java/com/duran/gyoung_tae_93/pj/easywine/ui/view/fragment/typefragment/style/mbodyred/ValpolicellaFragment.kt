...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentValpolicellaBinding
...
class ValpolicellaFragment : Fragment() {

    private lateinit var binding: FragmentValpolicellaBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_valpolicella, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_valpolicellaFragment_to_fragment_type)
        }
