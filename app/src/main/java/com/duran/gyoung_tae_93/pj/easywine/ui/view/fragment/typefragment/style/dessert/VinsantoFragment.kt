...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentSherryBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentVinsantoBinding
...
class VinsantoFragment : Fragment() {

    private lateinit var binding: FragmentVinsantoBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_vinsanto, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_vinsantoFragment_to_fragment_type)
        }
