...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentUSANorthwestBinding

class USANorthwestFragment : Fragment() {

    private lateinit var binding: FragmentUSANorthwestBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_u_s_a_northwest, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_USANorthwestFragment_to_fragment_type)
        }
    }
