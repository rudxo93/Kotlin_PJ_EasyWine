...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentFranceRhoneBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentItaliaToscanaBinding

class ItaliaToscanaFragment : Fragment() {

    private lateinit var binding: FragmentItaliaToscanaBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_italia_toscana, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_italiaToscanaFragment_to_fragment_type)
        }
    }
