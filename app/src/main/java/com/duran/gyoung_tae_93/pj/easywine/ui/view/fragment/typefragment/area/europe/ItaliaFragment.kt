...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentAustraliaBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentItaliaBinding

class ItaliaFragment : Fragment() {

    private lateinit var binding: FragmentItaliaBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_italia, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_italiaFragment_to_fragment_type)
        }
    }
