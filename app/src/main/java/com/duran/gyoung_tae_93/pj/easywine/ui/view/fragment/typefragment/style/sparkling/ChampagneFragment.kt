...
class ChampagneFragment : Fragment() {
    ...
    private lateinit var binding: FragmentChampagneBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_champagne, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_champagneFragment_to_fragment_type)
        }
