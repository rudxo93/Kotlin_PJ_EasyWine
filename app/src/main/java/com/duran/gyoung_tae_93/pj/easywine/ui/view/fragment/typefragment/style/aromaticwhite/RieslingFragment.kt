...
class RieslingFragment : Fragment() {

    private lateinit var binding: FragmentRieslingBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_riesling, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_rieslingFragment_to_fragment_type)
        }
