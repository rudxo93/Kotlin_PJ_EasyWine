...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentWineOpenBinding
import com.duran.gyoung_tae_93.pj.easywine.ui.view.activity.MainActivity
import com.google.android.material.bottomnavigation.BottomNavigationView

class WineOpenFragment : Fragment() {

    private lateinit var binding: FragmentWineOpenBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_wine_open, container, false)
        return binding.root
    }
    ...
    private fun getToolbarSetting() {
        binding.woToolbar.setTitle("와인 오픈하는 법")
