...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentMerlotBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentMontepulcianoBinding
...
class MontepulcianoFragment : Fragment() {

    private lateinit var binding: FragmentMontepulcianoBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_montepulciano, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_montepulcianoFragment_to_fragment_type)
        }
