...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentTempranilloBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentTourigaNacionalBinding
...
class TourigaNacionalFragment : Fragment() {

    private lateinit var binding: FragmentTourigaNacionalBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_touriga_nacional, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_tourigaNacionalFragment_to_fragment_type)
        }
