...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentPortBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentSauterneBinding
...
class SauterneFragment : Fragment() {

    private lateinit var binding: FragmentSauterneBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_sauterne, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_sauterneFragment_to_fragment_type)
        }
