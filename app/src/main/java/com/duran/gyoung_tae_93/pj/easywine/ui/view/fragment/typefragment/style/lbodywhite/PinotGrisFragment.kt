...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentMuscadetBinding
...
class PinotGrisFragment : Fragment() {

    private lateinit var binding: FragmentPinotGrisBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_pinot_gris, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_pinotGrisFragment_to_fragment_type)
        }
