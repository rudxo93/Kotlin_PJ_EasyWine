...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentMadeiraBinding
...
class MadeiraFragment : Fragment() {

    private lateinit var binding: FragmentMadeiraBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_madeira, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_madeiraFragment_to_fragment_type)
        }
