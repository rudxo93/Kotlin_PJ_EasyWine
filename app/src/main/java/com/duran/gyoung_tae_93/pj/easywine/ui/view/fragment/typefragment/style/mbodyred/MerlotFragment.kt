...
class MerlotFragment : Fragment() {

    private lateinit var binding: FragmentMerlotBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_merlot, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_merlotFragment_to_fragment_type)
        }
