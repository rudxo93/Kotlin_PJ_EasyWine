...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentBordeauxBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentCabernetSauvignonBinding
...
class CabernetSauvignonFragment : Fragment() {

    private lateinit var binding: FragmentCabernetSauvignonBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_cabernet_sauvignon, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_cabernetSauvignonFragment_to_fragment_type)
        }
