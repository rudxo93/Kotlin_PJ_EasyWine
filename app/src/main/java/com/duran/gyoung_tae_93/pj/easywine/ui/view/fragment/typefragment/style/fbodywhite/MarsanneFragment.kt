...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentMarsanneBinding
...
class MarsanneFragment : Fragment() {

    private lateinit var binding: FragmentMarsanneBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_marsanne, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_marsanneFragment_to_fragment_type)
        }
