...
class NewZealandFragment : Fragment() {

    private lateinit var binding: FragmentNewZealandBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_new_zealand, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_newZealandFragment_to_fragment_type)
        }
    }
