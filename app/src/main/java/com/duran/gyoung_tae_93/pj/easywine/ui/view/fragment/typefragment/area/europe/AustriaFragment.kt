...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentAustriaBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentSouthAfricaBinding

class AustriaFragment : Fragment() {

    private lateinit var binding: FragmentAustriaBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_austria, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_austriaFragment_to_fragment_type)
        }
    }
