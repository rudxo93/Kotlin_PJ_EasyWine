...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentGermanyBinding

class GermanyFragment : Fragment() {

    private lateinit var binding: FragmentGermanyBinding
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_germanyFragment_to_fragment_type)
        }
    }
