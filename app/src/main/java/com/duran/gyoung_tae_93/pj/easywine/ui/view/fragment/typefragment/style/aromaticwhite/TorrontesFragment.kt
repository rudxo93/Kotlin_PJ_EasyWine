...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentRieslingBinding
...
class TorrontesFragment : Fragment() {

    private lateinit var binding: FragmentTorrontesBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_torrontes, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_torrontesFragment_to_fragment_type)
        }
