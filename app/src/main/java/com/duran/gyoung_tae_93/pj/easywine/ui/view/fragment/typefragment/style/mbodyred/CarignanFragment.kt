...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentCarignanBinding
...
class CarignanFragment : Fragment() {

    private lateinit var binding: FragmentCarignanBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_carignan, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_carignanFragment_to_fragment_type)
        }
