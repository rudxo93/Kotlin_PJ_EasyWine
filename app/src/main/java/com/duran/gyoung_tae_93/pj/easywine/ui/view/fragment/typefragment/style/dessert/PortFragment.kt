...
class PortFragment : Fragment() {
    ...
    private lateinit var binding: FragmentPortBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_port, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_portFragment_to_fragment_type)
        }
