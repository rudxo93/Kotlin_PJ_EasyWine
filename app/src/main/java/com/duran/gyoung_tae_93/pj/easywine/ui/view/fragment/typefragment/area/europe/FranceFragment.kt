...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentFranceBinding

class FranceFragment : Fragment() {

    private lateinit var binding: FragmentFranceBinding
    ...
    private fun setFabButton() {
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_franceFragment_to_fragment_type)
        }
    }
