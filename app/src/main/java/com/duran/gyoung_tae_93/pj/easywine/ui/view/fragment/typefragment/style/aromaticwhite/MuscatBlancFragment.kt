...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentMuscatBlancBinding
...
class MuscatBlancFragment : Fragment() {

    private lateinit var binding: FragmentMuscatBlancBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_muscat_blanc, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_muscatBlancFragment_to_fragment_type)
        }
