...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentNoOpenerBinding
import com.duran.gyoung_tae_93.pj.easywine.ui.view.activity.MainActivity
import com.google.android.material.bottomnavigation.BottomNavigationView

class NoOpenerFragment : Fragment() {

    private lateinit var binding: FragmentNoOpenerBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_no_opener, container, false)
        return binding.root
    }
    ...
    private fun getToolbarSetting() {
        binding.noToolbar.setTitle("오프너가 없을 때")
