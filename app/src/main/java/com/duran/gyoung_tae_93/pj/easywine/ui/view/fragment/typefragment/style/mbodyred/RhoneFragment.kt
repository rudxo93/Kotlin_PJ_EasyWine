...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentRhoneBinding
...
class RhoneFragment : Fragment() {

    private lateinit var binding: FragmentRhoneBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_rhone, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_rhoneFragment_to_fragment_type)
        }
