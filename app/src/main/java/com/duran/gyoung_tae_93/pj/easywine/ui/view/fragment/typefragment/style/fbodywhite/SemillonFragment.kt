...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentSemillonBinding
...
class SemillonFragment : Fragment() {

    private lateinit var binding: FragmentSemillonBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_semillon, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_semillonFragment_to_fragment_type)
        }
