...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentWineChillingBinding
import com.duran.gyoung_tae_93.pj.easywine.ui.view.activity.MainActivity
import com.google.android.material.bottomnavigation.BottomNavigationView

class WineChillingFragment : Fragment() {

    private lateinit var binding: FragmentWineChillingBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_wine_chilling, container, false)
        return binding.root
    }
    ...
    private fun getToolbarSetting() {
        binding.wcToolbar.setTitle("와인 빠르게 칠링하는 법")
