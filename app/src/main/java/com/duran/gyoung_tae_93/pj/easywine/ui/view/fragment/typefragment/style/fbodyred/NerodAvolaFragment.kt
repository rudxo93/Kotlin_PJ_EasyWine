...
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentNebbioloBinding
import com.duran.gyoung_tae_93.pj.easywine.databinding.FragmentNerodAvolaBinding
...
class NerodAvolaFragment : Fragment() {

    private lateinit var binding: FragmentNerodAvolaBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_nerod_avola, container, false)
        return binding.root
    }
    ...
    private fun setFabButton() {
        ...
        binding.fabHome.setOnClickListener {
            it.findNavController().navigate(R.id.action_nerodAvolaFragment_to_fragment_type)
        }
